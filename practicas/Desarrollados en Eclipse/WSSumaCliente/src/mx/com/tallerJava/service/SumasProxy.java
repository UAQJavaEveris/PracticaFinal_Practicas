...
public class SumasProxy implements mx.com.tallerJava.service.Sumas {
  private String _endpoint = null;
  private mx.com.tallerJava.service.Sumas sumas = null;
  ...
  private void _initSumasProxy() {
    try {
      sumas = (new mx.com.tallerJava.service.SumasServiceLocator()).getSumasPort();
      if (sumas != null) {
        if (_endpoint != null)
  ...
  public mx.com.tallerJava.service.Sumas getSumas() {
    if (sumas == null)
      _initSumasProxy();
    return sumas;
  }
